...
exports.updateClassValidator = exports.getModuleByIdValidator = exports.getClassByIdValidator = exports.deleteClassValidator = exports.classValidator = void 0;
// Validator for creating a class
const classValidator = exports.classValidator = {
  classTitle: {
    in: 'body',
    exists: {
...
const getClassByIdValidator = exports.getClassByIdValidator = {
  classId: {
    in: 'body',
    exists: {
...
const updateClassValidator = exports.updateClassValidator = {
  id: {
    in: 'params',
    exists: {
...
const deleteClassValidator = exports.deleteClassValidator = {
  id: {
    in: 'params',
    exists: {
      errorMessage: 'Class ID is required'
